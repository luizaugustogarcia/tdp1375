...
//            super(parent, this.configurationPair, storage, minRate);
//        }
//
//        @Override
//        protected void compute() {
//            try {
//                val configuration = canonicalize(this.configurationPair);
//
...
//
//        @Override
//        protected Pair<Configuration, Set<Integer>> canonicalize(Configuration configuration) {
//            val canonical = Configuration.ofSignature(configuration.getSignature().getContent());
//            return Pair.of(canonical, getStandardPivots(canonical));
//        }
//
//        @Override
//        protected Set<Integer> getStandardPivots(Configuration configuration) {
