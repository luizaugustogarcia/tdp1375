...
public class Extensions {
    ...
    public void listen(final String config) {
        val parts = config.split("#");
        new SortOrExtendNew(rabbitTemplate, new Configuration(parts[0], parts[1]), storage, 1.6).compute();
    }

    @EventListener
    public void onContextStarted(final ContextStartedEvent cse) {
